...
if(user)
{
    ...
    const msg = {
        ...
        html: `<a href="http://13.231.236.235:3000/password/resetpassword/${id}">Reset password</a>`,
    }
        console.log(msg)
        return res.status(201).json({message: 'Link to reset password sent to your mail ', sucess: true,link :`http://13.231.236.235:3000/password/resetpassword/${id}`})
                    ...
                    const saltRounds = 10;
                         ...
                         bcrypt.hash(newpassword, saltRounds, function(err, hash) {
                            ...
                            user.update({ password: hash }).then(() => {
                               res.redirect('http://13.231.236.235:3000/login/login.html')
