...
function getExpense(){
    ...
    axios.get(`http://13.231.236.235:3000/expense/add-user?page=${page}`,{headers:{"Authorization":token}})
...
function addItem(e) {
    ...
    postRequest = async () => {
        try {
            ...
            const response = await axios.post("http://13.231.236.235:3000/expense/add-user", obj,{headers:{"Authorization":token}});
            console.log(response);
            ...
            {
                console.log(obj.id);
                const response = await axios.post(`http://13.231.236.235:3000/expense/edit-user/${obj.id}`, obj,{headers:{"Authorization":token}});
...
deleteUserfrombackend = async (id) => {
    const token=localStorage.getItem('token')
    try {
        const users = await axios.delete(`http://13.231.236.235:3000/expense/delete-user/${id}`,{headers:{"Authorization":token}});
...
BuyPremium=async function(e){
    const token=localStorage.getItem('token')
   // console.log(token);
    const response=await axios.get('http://13.231.236.235:3000/purchase/premiumembership', {headers : {"Authorization":token} } )
    console.log(response);
    ...
    var options ={
       ...
       const res= await axios.post("http://13.231.236.235:3000/purchase/updatetransactionstatus", {
...
function ShowLeaderboard(){
    ...
    LB.onclick= async() => {
        ...
        const token = localStorage.getItem('token')
        const userLeaderBoardArray = await axios.get('http://13.231.236.235:3000/premiumembership/showLeaderboard', { headers: {"Authorization" : token} })
        .then(response =>{
...
function download(){
    const token = localStorage.getItem('token')
   axios.get('http://13.231.236.235:3000/premiumembership/download', { headers: {"Authorization" : token} })
    .then((response) => {
